(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (wgrep-helm helm-cljouredocs lsp-java dap-mode posframe sbt-mode scala-mode ox-reveal org-plus-contrib utop tuareg ediprolog vue-mode pos-tip search-web ghc elisp-demos flutter dart-mode flymd poporg elm-mode livereload sicp lsp-rust lsp-python helm-lsp graphql-mode nvm company-lsp pact-mode js-comint nix-mode org-drill-table org-drill bookmark+ impatient-mode stream trie visual-fill-column achievements flycheck-plantuml plantuml-mode djvu apples-mode powerthesaurus goto-chg debug-print cnfonts go-errcheck go-eldoc go-dlv go-mode eredis pdf-tools markdown-preview-mode markdown-preview-eww buffer-flip org-wunderlist log4e log4j-mode helpful help-mode+ help-fns+ help+ markdown-mode+ paredit-everywhere paredit-menu jdee helm-ag csharp-mode helm-cljr cljr-helm zpresent org-bookmark-heading org-beautify-theme intero haskell-mode geiser tree-mode npm-mode doom-themes aggressive-indent pangu-spacing nrepl-eval-sexp-fu nrepl-sync monokai-theme darkokai-theme slim-mode coffee-mode vlf niceify-info hledger-mode suggest info+ org-alert alert helm-w3m language-detection pinyin-search wolfram-mode psysh sass-mode editorconfig ace-jump-mode atomic-chrome adoc-mode swbuff-x el-get e2wm e2wm-bookmark helm-github-stars bug-hunter emms-player-mpv emms-soundcloud helm-emms emms helm-mt multi-term poker beacon helm-chrome helm-cider-history helm-clojuredocs use-package keyfreq smooth-scrolling git-timemachine key-chord json-mode paper-theme yaml-mode blog-admin graphviz-dot-mode mic-paren rainbow-delimiters ac-cider auto-complete cider-eval-sexp-fu eval-sexp-fu align-cljlet uuid 4clojure helm-emmet emmet-mode smartscan helm-descbinds edit-server yesql-ghosts helm-cider core-async-mode clj-refactor js2-refactor js-mode fill-column-indicator change-inner wgrep visual-regexp swiper-helm elisp-slime-nav whitespace-cleanup-mode highlight-escape-sequences smart-forward encourage-mode encourange-mode fic-mode multiple-cursors string-edit less-css-mode rainbow-mode clojure-mode-extra-font-locking sx flycheck-clojure flycheck-pos-tip helm-swoop helm-ls-git org-repo-todo helm-projectile helm-ack org-redmine helm-org-rifle golden-ratio-scroll-screen chinese-font-setup undo-tree diminish exec-path-from-shell restclient guide-key flycheck move-text paredit helm)))
 '(pdf-view-midnight-colors (cons "#0F1019" "#EAF1FB"))
